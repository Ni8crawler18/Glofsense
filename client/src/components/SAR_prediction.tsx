...
interface TrendData {
  ...
  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
    <div>
      ...
      <p className="font-bold text-green-600">+0.005 km²</p>
    </div>
    <div>
      <span className="text-sm text-gray-600">Perimeter Change</span>
      <p className="font-bold text-green-600">+15 m</p>
    </div>
    <div>
      <span className="text-sm text-gray-600">Backscatter Change</span>
      <p className="font-bold text-green-600">-0.6 dB</p>
    </div>
    <div>
      <span className="text-sm text-gray-600">Coherence Change</span>
      <p className="font-bold text-green-600">-0.02</p>
    </div>
  </div>
</div>
